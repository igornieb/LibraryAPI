"""
Django settings for LibrayAPI project.
...
ROOT_URLCONF = 'LibrayAPI.urls'

WSGI_APPLICATION = 'LibrayAPI.wsgi.application'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=int(os.environ.get("ACCESS_TOKEN_LIFETIME", 20))),
